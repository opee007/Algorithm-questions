...
* 1. [剑指ｏffer](#ffer)
	...
	* 1.5. [从尾到头打印链表](#-1)
	* 1.6. [前序和中序遍历重建二叉树](#-1)
	* 1.7. [二叉树的下一个结点（给定father结点）](#father)
	* 1.8. [两个栈实现一个队列](#-1)
	* 1.9. [斐波那契数列](#-1)
	* 1.10. [旋转数组的最小数字（二分查找）](#-1)
	* 1.11. [矩阵中的路径（DFS路径）](#DFS)
	* 1.12. [机器人的运动范围（bfs搜索）](#bfs)
	* 1.13. [剪绳子（分段最大乘积）](#-1)
	* 1.14. [二进制中1的个数（unsigned int n = _n;）](#1unsignedintn_n)
	* 1.15. [实现数值的整数次方，即pow()](#pow)
	* 1.16. [在O(1)时间删除链表结点](#O1)
	* 1.17. [删除链表中重复的节点](#-1)
	* 1.18. [正则表达式匹配](#-1)
	* 1.19. [表示数值的字符串](#-1)
	* 1.20. [调整数组顺序使奇数位于偶数前面](#-1)
	* 1.21. [链表中倒数第k个节点](#k)
	* 1.22. [寻找环形链表入口](#-1)
	* 1.23. [翻转链表](#-1)
		* 1.23.1. [(1)迭代](#1)
		* 1.23.2. [(2) 递归](#2)
	* 1.24. [合并两个排序的链表](#-1)
	* 1.25. [树的子结构(判断B是不是A的子结构)](#BA)
	* 1.26. [二叉树的镜像](#-1)
	* 1.27. [判断对称（镜像）的二叉树](#-1)
	* 1.28. [顺时针打印矩阵](#-1)
	* 1.29. [包含min函数的栈](#min)
	* 1.30. [栈的压入、弹出序列](#-1)
	* 1.31. [不分行从上往下打印二叉树(层次遍历)](#-1)
	* 1.32. [分行从上往下打印二叉树](#-1)
	* 1.33. [之字形打印二叉树](#-1)
	* 1.34. [二叉树中和为某一值的路径(回溯)](#-1)
	* 1.35. [二叉搜索树的后序遍历序列](#-1)
	* 1.36. [二叉树中和为某一值的路径](#-1)
	* 1.37. [复杂链表的复刻](#-1)
* 2. [LeetCode](#LeetCode)
	...
	* 2.2. [2. 两数相加](#-1)
	* 2.3. [3. 无重复字符的最长子串](#-1)
	* 2.4. [4. 寻找两个正序数组的中位数](#-1)
	* 2.5. [5. 最长回文子串](#-1)
	* 2.6. [6. Z 字形变换](#Z)
	* 2.7. [7. 整数反转](#-1)
	* 2.8. [8. 字符串转换整数 (atoi)](#atoi)
	* 2.9. [9. 回文数](#-1)
	* 2.10. [10. 正则表达式匹配](#-1)
* 3. [岛屿问题](#-1)
	* 3.1. [岛屿数量](#-1)
...
##  1. <a name='ffer'></a>剑指ｏffer

###  1.1. <a name=''></a>找出数组中重复数字
...
###  1.7. <a name='father'></a>二叉树的下一个结点（给定father结点）
...
###  1.10. <a name='-1'></a>旋转数组的最小数字（二分查找）
...
###  1.11. <a name='DFS'></a>矩阵中的路径（DFS路径）
...
###  1.12. <a name='bfs'></a>机器人的运动范围（bfs搜索）
...
###  1.14. <a name='1unsignedintn_n'></a>二进制中1的个数（unsigned int n = _n;）
...
###  1.15. <a name='pow'></a>实现数值的整数次方，即pow()
...
###  1.16. <a name='O1'></a>在O(1)时间删除链表结点
...
###  1.20. <a name='-1'></a>调整数组顺序使奇数位于偶数前面
...
###  1.23. <a name='-1'></a>翻转链表

####  1.23.1. <a name='1'></a>(1)迭代
```c++
class Solution {
public:
...
###  1.25. <a name='BA'></a>树的子结构(判断B是不是A的子结构)
...
###  1.31. <a name='-1'></a>不分行从上往下打印二叉树(层次遍历)
...
###  1.34. <a name='-1'></a>二叉树中和为某一值的路径(回溯)
...
##  2. <a name='LeetCode'></a>LeetCode

###  2.1. <a name='-1'></a>1.两数之和
...
```
###  2.8. <a name='atoi'></a>8. 字符串转换整数 (atoi)
